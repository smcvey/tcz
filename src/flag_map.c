...
{
    /*  Free       */  0,
    /*  Thing      */  ABODE|ASHCAN|CENSOR|COMBAT|HAVEN|INVISIBLE|LOCKED|OPAQUE|OPEN|OPENABLE|PERMANENT|PRIVATE|QUIET|READONLY|SHARABLE|STICKY|TRANSFERABLE|VISIBLE|YELL,
    ...
    /*  Room       */  ABODE|ASHCAN|CENSOR|COMBAT|HAVEN|INVISIBLE|OPENABLE|PERMANENT|PRIVATE|QUIET|READONLY|SHARABLE|STICKY|TRANSFERABLE|VISIBLE|YELL,
